...
### **Trigger 2: Create Release (v3.0.3, v3.0.3, etc.)**
...
1. Download installer from GitHub Release
   - URL: github.com/brunoleocam/ZPL2PDF/releases/download/v3.0.3/ZPL2PDF-Setup-3.0.3.exe
...
7. Create Pull Request to microsoft/winget-pkgs
   - Title: "brunoleocam.ZPL2PDF version 3.0.3"
...
git tag -a test-v3.0.3 -m "Test release"
git push origin test-v3.0.3
